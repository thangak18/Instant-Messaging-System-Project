...
public class ChatListPanel extends JPanel {
                ...
                try {
                    ...
                    if (chats == null || chats.isEmpty()) {
                        ...
                        for (Map<String, Object> chat : chats) {
                            ...
                            String displayName = (friendName != null && !friendName.isEmpty()) ? friendName
                                    : friendUsername;
                            ...
                            ChatItemPanel item = new ChatItemPanel(friendUsername, displayName, lastMessage, timeStr,
                                    isOnline, unreadCount, sentAt);
    ...
    private void showEmptyMessage() {
        JLabel label = new JLabel(
                "<html><center><b>[Chat]</b><br><br>Chưa có cuộc trò chuyện nào<br>Hãy thêm bạn bè và bắt đầu chat!</center></html>");
    ...
    private void addChatItem(String username, String displayName, String lastMessage, String time, boolean online,
            int unreadCount) {
    ...
    private class ChatItemPanel extends JPanel {
        ...
        public ChatItemPanel(String username, String displayName, String lastMessage, String time, boolean online,
                int unreadCount, java.sql.Timestamp sentAt) {
            ...
            protected void done() {
                try {
                    ...
                    if (friends == null || friends.isEmpty()) {
                        JLabel label = new JLabel("<html><center><b>[?]</b><br><br>Không tìm thấy kết quả<br>cho '"
                                + searchText + "'</center></html>");
                        label.setFont(new Font(UIHelper.getDefaultFontName(), Font.PLAIN, 14));
                        label.setForeground(new Color(150, 150, 150));
                        label.setAlignmentX(Component.CENTER_ALIGNMENT);
                        label.setBorder(new EmptyBorder(80, 20, 80, 20));
                        ...
                        for (Map<String, Object> friend : friends) {
                            ...
                            ChatItemPanel item = new ChatItemPanel(friendUsername, displayName, "Bắt đầu trò chuyện",
                                    "", isOnline, 0, null);
                            item.addMouseListener(new java.awt.event.MouseAdapter() {
                                @Override
                                public void mouseClicked(java.awt.event.MouseEvent e) {
        ...
        SwingWorker<java.util.List<Map<String, Object>>, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    if (chats == null || chats.isEmpty()) {
                        JLabel label = new JLabel(
                                "<html><center>💤<br><br>Không có bạn bè nào đang online<br>Hãy quay lại sau!</center></html>");
                        label.setFont(new Font(UIHelper.getDefaultFontName(), Font.PLAIN, 14));
                        label.setForeground(new Color(150, 150, 150));
                        label.setAlignmentX(Component.CENTER_ALIGNMENT);
                        label.setBorder(new EmptyBorder(80, 20, 80, 20));
                ...
                protected void done() {
                    try {
                        ...
                        if (results == null || results.isEmpty()) {
                            JLabel label = new JLabel(
                                    "<html><center>😔 Không tìm thấy kết quả nào<br>Thử từ khóa khác</center></html>");
                            label.setFont(new Font(UIHelper.getDefaultFontName(), Font.PLAIN, 14));
                            label.setForeground(new Color(150, 150, 150));
                            label.setAlignmentX(Component.CENTER_ALIGNMENT);
                            ...
                            for (Map<String, Object> result : results) {
                                ...
                                String displayContent = content.length() > 100 ? content.substring(0, 100) + "..."
                                        : content;
                                JLabel contentLabel = new JLabel(
                                        "<html>" + highlightKeyword(displayContent, keyword) + "</html>");
