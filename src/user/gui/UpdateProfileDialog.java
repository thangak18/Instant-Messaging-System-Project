            ...
            protected void done() {
                try {
                    ...
                    if (userInfo != null) {
                        ...
                        if (gender != null) {
                            if (gender.equalsIgnoreCase("Nam")) genderComboBox.setSelectedIndex(0);
                            else if (gender.equalsIgnoreCase("Nữ")) genderComboBox.setSelectedIndex(1);
                            else genderComboBox.setSelectedIndex(2);
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
