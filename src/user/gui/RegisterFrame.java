...
public class RegisterFrame extends JFrame {
    ...
    private void initializeComponents() {
        ...
        // Gender combo - clean display without custom border
        ...
        genderCombo.setForeground(TEXT_COLOR);
        // Don't set custom border - causes display issues on macOS
    ...
    private JButton createPrimaryButton(String text) {
        ...
        button.setOpaque(true); // Required for macOS to show background color
