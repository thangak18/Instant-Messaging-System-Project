...
public class FriendRequestPanel extends JPanel {
    ...
    private class ReceivedRequestPanel extends JPanel {
        public ReceivedRequestPanel(Map<String, Object> requestData) {
            ...
            String createdAt = requestData.get("created_at") != null ? requestData.get("created_at").toString()
                    : "18/10";
            ...
            JLabel messageLabel = new JLabel("Xin chào, mình là " + (senderName != null ? senderName : senderUsername)
    ...
    private JButton createActionButton(String text, Color bgColor, Color fgColor) {
        ...
        button.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(bgColor.equals(Color.WHITE) ? new Color(200, 200, 200) : bgColor, 1,
                        true),
