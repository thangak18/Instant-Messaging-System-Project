...
public class ChatContentPanel extends JPanel {
    ...
    private JPanel createInputPanel() {
        ...
        sendButton.setOpaque(true); // Required for macOS
        sendButton.setContentAreaFilled(true); // Ensure background is painted
        ...
        deleteForMeItem.addActionListener(e -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if (success) {
                    ...
                    messageListPanel.revalidate();
                    messageListPanel.repaint();
                    JOptionPane.showMessageDialog(this, "Đã xóa tin nhắn", "Thành công",
            ...
            recallItem.addActionListener(e -> {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    if (success) {
                        ...
                        messageListPanel.revalidate();
                        messageListPanel.repaint();
                        JOptionPane.showMessageDialog(this, "Đã thu hồi tin nhắn", "Thành công",
                                JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(this, "Không thể thu hồi tin nhắn", "Lỗi",
    ...
    private void showReportSpamDialog() {
        ...
        submitButton.setOpaque(true); // Required for macOS
        submitButton.setContentAreaFilled(true); // Ensure background is painted
        submitButton.addActionListener(e -> {
            final String reason;
            if (spamMessagesBtn.isSelected())
                reason = "Tin nhắn spam";
            else if (harassmentBtn.isSelected())
                reason = "Quấy rối";
            else if (inappropriateBtn.isSelected())
                reason = "Nội dung không phù hợp";
            else if (scamBtn.isSelected())
                reason = "Lừa đảo";
                        ...
                        if (results == null || results.isEmpty()) {
                            ...
                            for (Map<String, Object> result : results) {
                                ...
                                JLabel contentLabel = new JLabel(
                                        "<html>" + highlightKeyword(content, keyword) + "</html>");
