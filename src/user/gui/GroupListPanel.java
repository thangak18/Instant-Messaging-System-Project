...
public class GroupListPanel extends JPanel {
    ...
    public void loadGroups() {
        ...
        JLabel loadingLabel = new JLabel("<html><center>🔄<br><br>Đang tải danh sách nhóm...</center></html>");
        ...
        loadingLabel.setBorder(new EmptyBorder(80, 20, 80, 20));
        groupsContainer.add(loadingLabel);
        groupsContainer.revalidate();
        groupsContainer.repaint();

        System.out.println("🔍 [GroupListPanel] Loading groups for user: " + mainFrame.getUsername());
        ...
        SwingWorker<List<Map<String, Object>>, Void> worker = new SwingWorker<>() {
            ...
            protected List<Map<String, Object>> doInBackground() {
                try {
                    ...
                    List<Map<String, Object>> result = groupService.getUserGroups(mainFrame.getUsername());
                    System.out.println("✅ [GroupListPanel] Got " + (result != null ? result.size() : 0) + " groups");
                    return result;
                } catch (Exception e) {
                    System.err.println("❌ [GroupListPanel] Error in doInBackground: " + e.getMessage());
                    e.printStackTrace();
                    return null;
                }
            }
            ...
            protected void done() {
                try {
                    ...
                    System.out.println(
                            "📊 [GroupListPanel] Displaying " + (groups != null ? groups.size() : 0) + " groups");
                    displayGroups(groups);
                } catch (Exception e) {
                    System.err.println("❌ [GroupListPanel] Error in done(): " + e.getMessage());
                    e.printStackTrace();

                    // Hiển thị lỗi cho người dùng
                    groupsContainer.removeAll();
                    JLabel errorLabel = new JLabel(
                            "<html><center>❌<br><br>Lỗi khi tải danh sách nhóm<br>Vui lòng thử lại sau</center></html>");
                    errorLabel.setFont(new Font(UIHelper.getDefaultFontName(), Font.PLAIN, 14));
                    errorLabel.setForeground(Color.RED);
                    errorLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
                    errorLabel.setBorder(new EmptyBorder(80, 20, 80, 20));
                    groupsContainer.add(errorLabel);
                    groupsContainer.revalidate();
                    groupsContainer.repaint();
                }
            }
        ...
        if (groups == null || groups.isEmpty()) {
            ...
            if (!searchText.isEmpty()) {
                ...
                emptyLabel = new JLabel(
                        "<html><center>Không tìm thấy nhóm<br>cho '" + searchText + "'</center></html>");
            } else {
                // Chưa có nhóm nào
